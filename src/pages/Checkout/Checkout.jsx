    ...
    <div className="max-w-7xl mx-auto p-8 mb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="card bg-white rounded-lg shadow p-6">
          <h2 className="text-2xl font-semibold text-center mb-4">Silver Plan</h2>
          <p className="text-center text-gray-600 mb-4">Basic access to all features</p>
        ...
        <div className="card bg-white rounded-lg shadow p-6">
          ...
          <p className="text-center text-gray-600 mb-4">Access to premium features</p>
        ...
        {/* Platinum Plan */}
        <div className="card bg-white rounded-lg shadow p-6">
          <h2 className="text-2xl font-semibold text-center mb-4">Platinum Plan</h2>
          <p className="text-center text-gray-600 mb-4">All features plus VIP support</p>
        ...
        <form>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input type="text" className="w-full p-3 mt-1 border border-gray-300 rounded-lg" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700">Email Address</label>
              <input type="email" className="w-full p-3 mt-1 border border-gray-300 rounded-lg" />
            </div>
          </div>

          <div className="mt-6">
            <label className="block text-sm font-medium text-gray-700">Shipping Address</label>
            <textarea className="w-full p-3 mt-1 border border-gray-300 rounded-lg" rows="4"></textarea>
          </div>

          <div className="mt-6">
            <label className="block text-sm font-medium text-gray-700">Credit Card Information</label>
            <input type="text" placeholder="Card Number" className="w-full p-3 mt-1 border border-gray-300 rounded-lg" />
          </div>
        </form>
      </div>
